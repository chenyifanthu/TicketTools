...
from ocr import predict_rec
from ocr import predict_det
from ocr import predict_structure
from ocr import utility
from ocr.matcher import distance, compute_iou
...
def to_excel(html_table, excel_path):
    from ocr.tablepyxl import tablepyxl
...
if __name__ == '__main__':
    ...
    in_dir = "/Users/chenyifan/data/讯飞表格数据"
